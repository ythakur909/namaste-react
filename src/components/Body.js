  ...
  const [listOfRestuarant, setListOfRestuarant] = useState([
    {
      ...
      analytics: {
        context: "seo-data-a6a1334d-8894-4fd1-9528-6141f01e8771",
      },
      cta: {
    ...
    },
    {
      info: {
        ...
        cuisines: ["Momos", "Pizzas", "Burgers", "rolls", "Beverages"],
        avgRating: 4.2,
        veg: true,
        parentId: "232865",
        avgRatingString: "4.2",
        ...
        availability: {
          nextCloseTime: "2024-08-24 22:40:00",
          opened: true,
        },
        badges: {
          imageBadges: [
  ...
  return (
    <div className="body">
      ...
      <div className="res-container">
        {listOfRestuarant.map((restuarant) => (
